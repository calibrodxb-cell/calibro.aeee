            ...
            {ctas.map((card) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-12 flex w-fit cursor-pointer items-center gap-10 border border-white px-4 py-3 text-[11px] font-normal leading-[1.4] tracking-normal uppercase transition-all duration-300 hover:bg-white hover:text-[#1f2321]"
                >
                  {card.button}
                  <span>→</span>
                </button>
